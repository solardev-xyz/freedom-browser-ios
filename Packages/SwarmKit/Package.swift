...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "FreedomMobile",
            url: "https://github.com/solardev-xyz/freedom-mobile-ffi/releases/download/v0.5.0/FreedomMobile.xcframework.zip",
            checksum: "c425b8fe987a84d726d5ebfe4aad27a731ae3bef66342a049ca7372b504cafb6"
        ),
        .target(
            name: "SwarmKit",
